...
public class PDFGeneration {
	...
	@Given("^I want to create an XML with precondition$")
	public void i_want_to_create_an_XML_with_precondition() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Given("^Fire the soap request$")
	public void fire_the_soap_request() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	@Then("^I validate the responce of Soap$")
	public void i_validate_the_responce_of_Soap() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^Check for file exists$")
	public void check_for_file_exists() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@When("^I complete the action$")
	public void i_complete_the_action() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Given("^I want to extract the pdf$")
	public void i_want_to_extract_the_pdf() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
